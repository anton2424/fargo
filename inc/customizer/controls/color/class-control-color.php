<?php
/**
 * Customizer Control: Fargo-color.
 *
 ...
 * Color control
 */
class Fargo_Customizer_Color_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'fargo-color', get_template_directory_uri() .'/inc/customizer/controls/color/js/color.min.js', array( 'jquery', 'customize-base', 'wp-color-picker' ), false, true );
		wp_enqueue_style( 'fargo-color', get_template_directory_uri() .'/inc/customizer/controls/color/css/color.min.css', array( 'wp-color-picker' ), '1.0.0' );
	}
